...
PAPER_POLICY = PaperPolicy(
    ...
    daily_stake_cap=float(os.getenv("PAPER_DAILY_STAKE_CAP", "60")),
    daily_loss_stop=float(os.getenv("PAPER_DAILY_LOSS_STOP", "200")),
    max_open_entries=int(os.getenv("PAPER_MAX_OPEN_ENTRIES", "6")),
    max_far_open_entries=int(os.getenv("PAPER_MAX_FAR_OPEN_ENTRIES", "2")),
...
PAPER_DAILY_SCAN_CAP = int(os.getenv("PAPER_DAILY_SCAN_CAP", "48"))
